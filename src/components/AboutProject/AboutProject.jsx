        ...
        <section className='aboutproject'>
            ...
            <div className='aboutproject__time-container'>
                <div className='aboutproject__one-week-container'>
                    <div className='aboutproject__one-week-line'><p className='aboutproject__one-week-line-text'>1 неделя</p></div>
                    <p className='aboutproject__time-caption'>Back-end</p>
                </div>
                <div className='aboutproject__four-week-container'>
                    <div className='aboutproject__four-week-line'><p className='aboutproject__four-week-line-text'>4 недели</p></div>
